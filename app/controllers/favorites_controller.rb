class FavoritesController < ApplicationController
  before_action :current_user_must_be_favorite_user,
  ...
  def index
    ...
    @favorites = @q.result(distinct: true).includes(:user, :restaurant,
  ...
  def favorite_params
    params.require(:favorite).permit(:user_id, :dish_id, :restaurant_id)
  end
end
